...
This is the origin Pytorch implementation of CDLtvS in the following paper: 
[A Cross-Domain Method for Customer Lifetime Value Prediction in Supply Chain Platform]
<!-- 
(https://arxiv.org/abs/2012.07436). Special thanks to `Jieqi Peng`@[cookieminions](https://github.com/cookieminions) for building this repo.
